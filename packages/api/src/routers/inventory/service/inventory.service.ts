  ...
  public async getInventory(
    ...
    try {
      ...
      const result = await inventoryRepository.getInventory({
        ...
        minEngineSize: input.minEngineSize,
        minHorsepower: input.minHorsepower,
        minMpgCity: input.minMpgCity,
        minMpgHighway: input.minMpgHighway,
        minMpgCombined: input.minMpgCombined,
        hideWithoutPhotos: input.hideWithoutPhotos,
        singleOwner: input.singleOwner,
        priceDrops: input.priceDrops,
        onlineFinancing: input.onlineFinancing,
        financingOptions: input.financingOptions,
        minDaysOnMarket: input.minDaysOnMarket,
        maxDaysOnMarket: input.maxDaysOnMarket,
