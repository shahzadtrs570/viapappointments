...
export function BudgetCalculator() {
  ...
  const calculateBudget = () => {
    ...
    const totalInterest =
      totalPayments - totalPayments / (1 + monthlyRate * loanTerm)
            ...
            >
              ...
              <div className="text-center">
                <p className="text-base font-medium text-gray-700 dark:text-gray-300 leading-relaxed">
                  Estimated payments are for{" "}
                  <span className="font-bold">informational purposes only</span>
                  , and do not represent a financing offer or guarantee of
                  credit from the seller. Estimated payments may exclude{" "}
                  <span className="font-bold">title and registration fees</span>{" "}
                  and may not account for all{" "}
                  <span className="font-bold">
                    dealer charges and governmental fees
                  </span>
                  .
                </p>
              </div>
