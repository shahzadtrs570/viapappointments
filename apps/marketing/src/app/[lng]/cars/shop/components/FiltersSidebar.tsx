...
export default function FiltersSidebar({ filters, onFilterChange, cars }: FiltersSidebarProps) {
          ...
          <div className="space-y-4">
            ...
            <div>
              <select
                ...
                onChange={(e) => handleFilterUpdate('bodyStyle', e.target.value)}
                className="w-full p-3 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium"
              >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFilterUpdate('priceRange', [parseInt(e.target.value) || 0, localFilters.priceRange[1]])}
                className="w-full p-3 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFilterUpdate('priceRange', [localFilters.priceRange[0], parseInt(e.target.value) || 200000])}
                className="w-full p-3 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="p-4 pb-2">
        <div className="flex bg-gray-100 rounded-full p-1">
          <button className="flex-1 py-2 px-4 rounded-full bg-black text-white text-sm font-bold">
            Used
          </button>
          <button className="flex-1 py-2 px-4 rounded-full text-gray-600 text-sm font-bold hover:bg-gray-200">
            New
          </button>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200">
        ...
        <div className="border-b border-gray-200">
          ...
          >
            <span className="text-sm font-bold text-gray-900">Location & delivery</span>
            <svg
          ...
          {expandedSections.location && (
            <div className="px-4 pb-4 space-y-4">
              <div className="flex items-center text-sm">
                ...
                <button className="text-blue-600 font-medium hover:underline">Add location</button>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    <input type="radio" name="delivery" value="yes" className="text-blue-600" defaultChecked />
                    <span className="ml-2 text-sm text-gray-900">Yes</span>
                  </label>
                  <label className="flex items-center">
                    <input type="radio" name="delivery" value="no" className="text-blue-600" />
        ...
        <div className="border-b border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
          >
            <span className="text-sm font-bold text-gray-900">Price & payment</span>
            <svg
              className={`w-5 h-5 text-gray-400 transition-transform ${
          ...
          {expandedSections.pricePayment && (
            <div className="px-4 pb-4 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-bold text-gray-900">Vehicle price</span>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleFilterUpdate('priceRange', [value, localFilters.priceRange[1]]);
                      }}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        const value = parseInt(e.target.value.replace(/[^0-9]/g, '')) || 200000;
                        handleFilterUpdate('priceRange', [localFilters.priceRange[0], value]);
                      }}
                      className="w-full p-2 border border-gray-300 rounded text-sm font-medium"
                    />
                  </div>
                ...
                <div className="px-2">
                  <input
                    ...
                    step="1000"
                    value={localFilters.priceRange[1]}
                    onChange={(e) => handleFilterUpdate('priceRange', [localFilters.priceRange[0], parseInt(e.target.value)])}
                    className="w-full h-2 bg-blue-200 rounded-lg appearance-none cursor-pointer slider"
                  />
                </div>
                
                <div className="text-center">
                  <div className="text-sm text-gray-600 mb-1">Estimated max payment*</div>
        ...
        <div className="border-b border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
          >
            <span className="text-sm font-bold text-gray-900">Online shopping options</span>
            <svg
              className={`w-5 h-5 text-gray-400 transition-transform ${
              ...
              <label className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 mt-1">
                    Show listings with financing, trade-in valuation & dealership appointments available
                  </div>
                </div>
              </label>
            </div>
        ...
        <div className="border-b border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
          >
            <span className="text-sm font-bold text-gray-900">Exterior color</span>
            <svg
              className={`w-5 h-5 text-gray-400 transition-transform ${
        ...
        <div className="border-b border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
          >
            <span className="text-sm font-bold text-gray-900">Interior color</span>
            <svg
              className={`w-5 h-5 text-gray-400 transition-transform ${
        ...
        <div>
            ...
            >
             ...
             <div className="px-4 pb-4 space-y-3">
               {[
                 ...
                 <label key={engine.name} className="flex items-center space-x-3">
                   <input type="checkbox" className="text-blue-600" />
                   <span className="text-sm text-gray-900">
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Hybrid & electric</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
           ...
           {expandedSections.hybridElectric && (
             <div className="px-4 pb-4 space-y-6">
               <div>
                 <div className="text-sm font-medium text-gray-900 mb-2">EV battery range</div>
                 <div className="text-sm text-gray-600 mb-3">14 miles - 469 miles</div>
                 <input
                   type="range"
                   min="14"
                   max="469"
               ...
               <div>
                 <div className="text-sm font-medium text-gray-900 mb-2">EV battery charging time</div>
                 <div className="text-sm text-gray-600 mb-3">2 hours - 16 hours</div>
                 <input
                   type="range"
                   min="2"
                   max="16"
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">New / Used / CPO</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
             ...
             <div className="px-4 pb-4 space-y-4">
               ...
               <div className="space-y-3">
                 {[
                   ...
                   <label key={feature.name} className="flex items-center space-x-3">
                     <input type="checkbox" className="text-blue-600" />
                     <span className="text-sm text-gray-900">
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Number of seats</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Number of doors</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
         ...
         <div className="border-b border-gray-200">
           ...
           {expandedSections.dealRating && (
             <div className="px-4 pb-4 space-y-3">
               {[
                 { name: 'Great Deal', count: 654, icon: '🟢', color: 'text-green-600' },
                 { name: 'Good Deal', count: 2011, icon: '🟢', color: 'text-green-600' },
                 { name: 'Fair Deal', count: 3403, icon: '🟡', color: 'text-yellow-600' },
                 { name: 'High Priced', count: 1330, icon: '🟠', color: 'text-orange-600' },
                 { name: 'Overpriced', count: 579, icon: '🔴', color: 'text-red-600' },
                 { name: 'Uncertain', count: 97, icon: '❓', color: 'text-gray-600' },
                 { name: 'No Rating', count: 1478, icon: '⚫', color: 'text-gray-600' }
               ].map((rating) => (
                 <label key={rating.name} className="flex items-center space-x-3">
                   <input type="checkbox" className="text-blue-600" />
                   <span className={`text-sm ${rating.color}`}>{rating.icon}</span>
                   <span className="text-sm text-gray-900">
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Vehicle history</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
           ...
           {expandedSections.vehicleHistory && (
             <div className="px-4 pb-4 space-y-4">
               ...
               <div>
                 <div className="text-sm font-bold text-gray-900 mb-3">Hide vehicles with:</div>
                 <div className="space-y-3">
                   {[
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Days on market</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">NHTSA overall safety rating</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
           ...
           {expandedSections.safetyRating && (
             <div className="px-4 pb-4 space-y-3">
               {[
                 ...
                 <label key={rating.name} className="flex items-center space-x-3">
                   <input type="radio" name="safetyRating" className="text-blue-600" />
         ...
         <div className="border-b border-gray-200">
           <button
             ...
             className="w-full flex items-center justify-between p-4 text-left hover:bg-gray-50"
           >
             <span className="text-sm font-bold text-gray-900">Dealer rating</span>
             <svg
               className={`w-5 h-5 text-gray-400 transition-transform ${
           ...
           {expandedSections.dealerRating && (
             <div className="px-4 pb-4 space-y-3">
               {[
                 ...
                 <label key={rating.name} className="flex items-center space-x-3">
                   <input type="radio" name="dealerRating" className="text-blue-600" />
                   <span className="text-sm text-blue-600">
                     {rating.name} ({rating.count.toLocaleString()})
                   </span>
                 </label>
