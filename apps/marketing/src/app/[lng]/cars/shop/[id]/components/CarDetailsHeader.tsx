...
export default function CarDetailsHeader({
  ...
  const getDealRating = (price: number, msrp: number) => {
    ...
    if (percentage < 0)
      return { rating: "Overpriced", color: "text-red-600", bg: "bg-red-100" }
    return {
      rating: "High Priced",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-600">
            <span>
              Result {currentIndex + 1} of {totalCars.toLocaleString()}
            </span>
            ...
            <div className="lg:flex-1">
              ...
              <div className="flex items-center space-x-4 mb-4">
                <div className="flex items-baseline space-x-2">
                  ...
                  {msrpAmount > priceAmount && (
                    <span className="text-lg text-gray-500 line-through">
                      ${msrpAmount.toLocaleString()}
                    </span>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div
                  className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${dealInfo.bg} ${dealInfo.color}`}
                >
                  <svg
                    className="w-4 h-4 mr-1"
                    fill="currentColor"
