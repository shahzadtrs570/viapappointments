      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <div className="flex items-center space-x-4">
          <img
            src={
              car.images?.[0] ||
              "https://images.unsplash.com/photo-1550355291-bbee04a92027?w=200&q=80"
            }
          ...
          <div className="flex-1">
            ...
            <div className="text-sm text-gray-600">
              Mileage: {car.mileage?.toLocaleString() || "N/A"} •{" "}
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="text-sm text-gray-600 mt-1">
            ${((car.msrpAmount || 0) - (car.priceAmount || 0)).toLocaleString()}{" "}
            Below market
          </div>
        </div>
        ...
        <div className="mt-4 space-y-2">
          <button
            onClick={handleCheckAvailability}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded text-sm transition-colors"
          >
            Check availability
          </button>
