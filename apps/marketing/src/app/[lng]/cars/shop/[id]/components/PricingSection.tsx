...
export default function PricingSection({ car }: PricingSectionProps) {
  ...
  const getDealRating = () => {
    if (savingsPercent >= 15)
      return { text: "Great Deal", color: "text-green-600", bg: "bg-green-100" }
    if (savingsPercent >= 10)
      return { text: "Good Deal", color: "text-green-600", bg: "bg-green-100" }
    if (savingsPercent >= 5)
      return {
        text: "Fair Deal",
    ...
    <div className="space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Find financing options, value your trade-in, and choose service
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Head to the dealership to finish up your sale.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div className="mb-6">
          ...
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${dealRating.bg} ${dealRating.color} mb-4`}
          >
            <svg
        ...
        <div className="mb-6">
          <p className="text-gray-700 mb-4">
            This car is ${savings.toLocaleString()} below market price. We
            compared this car with similar {car.year} {car.make} {car.model}
            based on price, mileage, features, condition, dealer reputation, and
            other factors.
          </p>
        </div>
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">
                On the market longer than average. There may be flexibility on
                price.
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-medium text-gray-900">
                65 days at this dealership
              </div>
              <div className="text-sm text-gray-600">
                65 days on CarGurus • 16 saves
              </div>
            </div>
          </div>
        </div>
        ...
        >
          Show price history
          <svg
            className={`w-4 h-4 ml-1 transition-transform ${showHistory ? "rotate-180" : ""}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-600 mb-4">
            Sound good? Start your purchase to complete paperwork online before
        ...
        <p className="text-xs text-gray-500 mt-4">
          *Estimated payments are for informational purposes only, and do not
          represent a financing offer or guarantee of credit from the seller.
        </p>
      </div>
    </div>
  )
