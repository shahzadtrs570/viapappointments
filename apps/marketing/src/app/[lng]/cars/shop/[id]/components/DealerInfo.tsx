...
import { getVehicleUrl } from "../utils/vehicleUrl"
...
export default function DealerInfo({ car }: DealerInfoProps) {
  ...
  // Extract dealer website from vehicle URL (get base domain)
  const getDealerWebsite = () => {
  ...
  const recommendedCars = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1617814076367-b759c7d7e738?w=300&q=80",
    },
  ]
  ...
  return (
    <div className="space-y-8 mt-12">
        ...
        <div className="border-t pt-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">
              Predawn Gray Mica 2018 Toyota Camry LE Clean CARFAX. Camry LE, 4D
              Sedan, 2.5L I4 DOHC 16V, 8-Speed Automatic, FWD, Predawn Gray
              Mica, Black w/Fabric Seat Trim, 4-Wheel Disc Brakes, 6 Speakers,
              ABS brakes, Active Cruise Control, Alloy wheels, AM/FM radio, Auto
              High-beam Headlights, Blind Spot Monitor w/Rear Cross Traffic
              Alert, Brake assist, Bumpers: body-color, Convenience Package,
              Delay-off headlights, Driver door bin, Driver vanity mirror, Dual
              front impact airbags, Dual front side impact airbags, Electronic
              Stability Control, Exterior Parking Camera Rear, Fabric Seat Trim,
              Four wheel independent suspension, Front anti-roll bar, Front
              Bucket...
            </p>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 text-sm">
              To the price of each vehicle there will be added the sum of $599
              D&H fee
            </p>
            ...
            >
              ...
              <div className="p-4">
                <h4 className="font-bold text-gray-900 mb-1">
                  {recommendedCar.year} {recommendedCar.make}{" "}
                  {recommendedCar.model}
                </h4>
      ...
      <div className="text-center text-xs text-gray-500 pt-4 border-t border-gray-200">
        <p>
          <sup>1</sup> Vehicle history data provided by Experian AutoCheck on
          May 5, 2025. This data, and any reliance on it is subject to the
          AutoCheck Terms and Conditions and the CarGurus Terms of Use.
        </p>
        <p className="mt-2">
          Vehicle information is provided by the seller or other third parties;
          CarGurus is not responsible for the accuracy of such information.
          Price may exclude certain taxes, fees, and/or charges. See seller for
          details.
        </p>
      </div>
    </div>
