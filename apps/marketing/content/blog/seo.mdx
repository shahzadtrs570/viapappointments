...
description: The blog posts already have built in SEO with meta tags, open graph, and twitter cards.
publishedAt: '2024-04-19'
updatedAt: '2023-04-20'
coverImage: /images/blog/pagination-cover.png
authorName: Renas Hassan
keywords: [seo, meta-tags, open-graph, twitter-cards]
published: true
---

<div className="border text-center border-primary rounded-md border-l-4">
The text below is from the [Tailwind CSS](https://play.tailwindcss.com/uj1vGACRJA?layout=preview) docs. I copied it here to showcase the markdown styles.
</div>
