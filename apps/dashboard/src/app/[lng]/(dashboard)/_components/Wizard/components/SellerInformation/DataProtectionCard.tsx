...
import { CheckmarkIcon } from "./FormIcons"
  ...
  return (
    <div className="mb-4 rounded-lg border border-border/60 bg-card/90 p-3 shadow-md backdrop-blur-sm transition-all duration-300 hover:bg-card hover:shadow-lg sm:mb-6 sm:p-4 md:p-6">
      <h3 className="mb-2 text-base font-medium text-primary sm:text-lg">
        {t("wizard_seller_information:dataProtection.title")}
      </h3>

      <p className="mb-2 text-xs text-muted-foreground sm:text-sm">
        {t("wizard_seller_information:dataProtection.description")}
      </p>
      ...
      <div className="space-y-2 sm:space-y-3">
        <div className="group flex items-start rounded-md transition-all duration-200 hover:bg-background/40">
          ...
          <div className="ml-2 sm:ml-3">
            <h4 className="text-xs font-medium text-card-foreground sm:text-sm">
              {t(
                "wizard_seller_information:dataProtection.secureStorage.title"
              )}
            </h4>
            <p className="text-xs text-muted-foreground sm:text-sm">
              {t("wizard_seller_information:dataProtection.secureStorage.text")}
            </p>
          </div>
        </div>
        ...
        <div className="group flex items-start rounded-md transition-all duration-200 hover:bg-background/40">
          ...
          <div className="ml-2 sm:ml-3">
            <h4 className="text-xs font-medium text-card-foreground sm:text-sm">
              {t(
                "wizard_seller_information:dataProtection.limitedAccess.title"
              )}
            </h4>
            <p className="text-xs text-muted-foreground sm:text-sm">
              {t("wizard_seller_information:dataProtection.limitedAccess.text")}
            </p>
          </div>
        </div>
        ...
        <div className="group flex items-start rounded-md transition-all duration-200 hover:bg-background/40">
          ...
          <div className="ml-2 sm:ml-3">
            <h4 className="text-xs font-medium text-card-foreground sm:text-sm">
              {t("wizard_seller_information:dataProtection.yourRights.title")}
            </h4>
            <p className="text-xs text-muted-foreground sm:text-sm">
              {t("wizard_seller_information:dataProtection.yourRights.text")}
            </p>
          </div>
        </div>
      </div>
